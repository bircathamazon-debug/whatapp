...
const STRINGS = {
  he: {
    ...
    outsideWorkingHours: (dayLabel) => `אין קבלה בשעה הזו ב-${dayLabel} — זה מחוץ לשעות הפעילות. השעות הפנויות:`,
  ...
  en: {
    ...
    otherDay: (weekday, dd, mm) => `${weekday} ${dd}/${mm}`,
    outsideWorkingHours: (dayLabel) => `We're closed at that time on ${dayLabel} — it's outside working hours. Available times:`,
  ...
  es: {
    ...
    otherDay: (weekday, dd, mm) => `${weekday} ${dd}/${mm}`,
    outsideWorkingHours: (dayLabel) => `A esa hora está cerrado el ${dayLabel} — es fuera del horario de atención. Los horarios disponibles son:`,
